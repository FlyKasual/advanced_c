...
```bash
gcc -Wall -Wextra -Wpedantic -Werror -O3 --std=c17 -fPIC -I challenge31/lib/include -c challenge31/lib/src/libStringFunctions.c -o challenge31/lib/libStringFunctions.o
